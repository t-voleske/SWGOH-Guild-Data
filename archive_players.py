...
def archive_process():
    guilds_config = check_none(read_guild(), 'Error: read_guild function should not return None')

    raw_players_data = check_none(read_players_raw(), 'Error: read_players_raw function should not return None')
